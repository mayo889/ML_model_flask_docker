...
modelpath = "/app/app/models/heart_attack_random_forest.dill"
...
def predict():
	...
	if flask.request.method == "POST":
		...
		if request_json["thalach"]:
			thalach = request_json['thalach']
		if request_json["exang"]:
		...
		try:
			preds = model.predict_proba(pd.DataFrame({"age": [age], "sex": [sex], "cp": [cp], 
													"trestbps": [trestbps], "chol": [chol], "fbs": [fbs],
													"restecg": [restecg], "thalach": [thalach], "exang": [exang],
